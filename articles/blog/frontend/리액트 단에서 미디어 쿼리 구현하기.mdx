...
<section className={'flex items-center justify-center'}>
  <Image src="media-query.gif" alt="Media Query Example" className={'w-full'} />
</section>
...
<section className={'my-[-50px] flex items-center justify-center'}>
  <Image src="width.png" alt="width capture" className={'w-[500px]'} />
</section>
...
<section className={'my-[-30px] flex items-center justify-center'}>
  <Image src="media-query-result.gif" alt="Media Query Example" className={'w-full'} />
</section>
