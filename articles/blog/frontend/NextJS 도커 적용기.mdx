...
<section className={'my-[-10px] flex items-center justify-center'}>
  <Image src="docker.png" alt="Docker Image" className={'w-1/2'} />
</section>
...
<section className={'my-[-30px] flex items-center justify-center'}>
  <Image src="docker-proxy.png" alt="Docker Image" className={'w-full'} />
</section>
